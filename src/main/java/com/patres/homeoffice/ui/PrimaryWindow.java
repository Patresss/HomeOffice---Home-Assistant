...
public class PrimaryWindow {
    ...
    public PrimaryWindow(final Stage primaryStage, final WorkManager workManager, final SettingsManager settingsManager, final Image icon) {
    ...
    public Stage createWindow() throws IOException {
        ...
        final MainPane root = new MainPane(primaryStage, windowSettings.pinned(), workManager);
